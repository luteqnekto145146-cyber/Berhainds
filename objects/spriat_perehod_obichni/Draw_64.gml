...
draw_sprite_ext(poopkakoito, image_index, 0, 0, display_get_width() / sprite_get_width(Sprite13), display_get_height() / sprite_get_height(Sprite13), 0, $FFFFFF & $ffffff, 1);
